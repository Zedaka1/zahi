...
export const services: Service[] = [
  ...
  },
  {
    key: "turnkey",
    title: "מבטון עד מפתח",
    desc: "ניהול וביצוע של הפרויקט כולו תחת קבלן אחד — אתה מקבל בית מוכן למגורים.",
  },
];
...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    a: "זה אומר שאני מנהל ומבצע את כל הפרויקט תחת קורת גג אחת — הריסה, בנייה, אינסטלציה, חשמל, גבס, ריצוף, צבע וגמר — עד שאתה מקבל בית מוכן למגורים עם מפתח ביד.",
  },
  {
    q: "יש אחריות על העבודה?",
    a: "כן. כל עבודה מבוצעת לפי תקן ומלווה באחריות. הרישיון (קבלן ג-100) והניסיון הם הביטחון שלך לעבודה מקצועית ואמינה.",
  },
];

...
const docs: Record<LegalDoc, { title: string; body: ReactNode }> = {
  ...
  privacy: {
    ...
    body: (
      <>
        <p className="mb-5 text-[15px] leading-relaxed text-muted">
          הפרטיות שלכם חשובה לנו. מדיניות זו מסבירה איזה מידע נאסף באתר וכיצד
          אנו עושים בו שימוש.
        </p>
        <Section title="איזה מידע נאסף">
          <p>
            מידע שתמסרו ביוזמתכם בטופס יצירת הקשר (שם, מספר טלפון ופרטי הפנייה),
        ...
        <Section title="אבטחת מידע וזכויותיכם">
          <p>
            אנו נוקטים אמצעים סבירים לשמירת המידע. באפשרותכם לפנות אלינו לעיון
            במידע שנמסר על ידכם, לתיקונו או למחיקתו.
          </p>
          <p>
